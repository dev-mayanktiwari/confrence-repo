...
export const metadata: Metadata = {
  ...
  description:
    "Stay informed about important dates for the National Conference on Computer and Communications (NCCC) 2025, including submission deadlines, registration, and event schedule.",
};
