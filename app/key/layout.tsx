...
export const metadata: Metadata = {
  title: "Key Dates - ICCC 2025",
  description:
    "Stay informed about important dates for the International Conference on Computer and Communications (ICCC) 2025, including submission deadlines, registration, and event schedule.",
};
