...
export const metadata: Metadata = {
  ...
  description:
    "Submit your papers to the International Conference on Computer and Communications (ICCC 2025) and explore a wide range of research areas including communications, network theory, and signal processing. Join us at Galgotia College of Engineering and Technology in April 2025.",
  keywords: [
    "ICCC 2025",
    "Call for Papers",
    "Communications",
