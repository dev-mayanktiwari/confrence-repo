...
export const metadata: Metadata = {
  title: "Registration - ICCC 2025",
  description:
    "Register for the International Conference on Computer and Communications (ICCC) 2025. Find registration details, fees, and important deadlines.",
};
